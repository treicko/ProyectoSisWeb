...
/*
	if ($tabla=='vehiculos') {
		$direccion='http://localhost/ProyectoSisWeb/ProyectoSisWeb/vehiculo/';
	}elseif ($tabla=='accesorios') {
		$direccion='http://localhost/ProyectoSisWeb/ProyectoSisWeb/accesorio/';
